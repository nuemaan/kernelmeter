...
DATABASE: tuple[GpuSpec, ...] = (
    ...
    GpuSpec("v100-pcie", "Tesla V100 PCIe", (7, 0), 80, 1380, 4096, 1.758, 250),
    GpuSpec("a30", "A30", (8, 0), 56, 1440, 3072, 2.43, 165),
    ...
    GpuSpec("l40", "L40", (8, 9), 142, 2490, 384, 18.0, 300),
    GpuSpec("l40s", "L40S", (8, 9), 142, 2520, 384, 18.0, 350),
    GpuSpec("rtx-a4000", "RTX A4000", (8, 6), 48, 1560, 256, 14.0, 140),
    GpuSpec("rtx-a5000", "RTX A5000", (8, 6), 64, 1695, 384, 16.0, 230),
    GpuSpec("rtx-a6000", "RTX A6000", (8, 6), 84, 1800, 384, 16.0, 300),
    GpuSpec("rtx-6000-ada", "RTX 6000 Ada", (8, 9), 142, 2505, 384, 20.0, 300),
    GpuSpec("titan-rtx", "Titan RTX", (7, 5), 72, 1770, 384, 14.0, 280),
    GpuSpec("rtx-2080-ti", "GeForce RTX 2080 Ti", (7, 5), 68, 1545, 352, 14.0, 250),
    ...
    GpuSpec("rtx-3080-ti", "GeForce RTX 3080 Ti", (8, 6), 80, 1665, 384, 19.0, 350),
    GpuSpec("rtx-3090", "GeForce RTX 3090", (8, 6), 82, 1695, 384, 19.5, 350),
    GpuSpec("rtx-3090-ti", "GeForce RTX 3090 Ti", (8, 6), 84, 1860, 384, 21.0, 450),
    GpuSpec("rtx-4080", "GeForce RTX 4080", (8, 9), 76, 2505, 256, 22.4, 320),
    GpuSpec("rtx-4090", "GeForce RTX 4090", (8, 9), 128, 2520, 384, 21.0, 450),
    GpuSpec("rtx-5070", "GeForce RTX 5070", (12, 0), 48, 2512, 192, 28.0, 250),
    GpuSpec("rtx-5070-ti", "GeForce RTX 5070 Ti", (12, 0), 70, 2452, 256, 28.0, 300),
